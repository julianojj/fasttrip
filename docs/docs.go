...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/usecases.RegisterRoomInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/usecases.RegisterRoomOutput"
                            }
                        }
                    },
                    "400": {
        ...
        "/register_user": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "RegisterUserInput",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/usecases.RegisterUserInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/usecases.RegisterUserOutput"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "usecases.GetBookingGuestsOutput": {
            "type": "object",
            "properties": {
                "birth_date": {
                    "type": "string",
                ...
                "guest_id": {
                    "type": "string",
                    "example": "326ebf92-1597-4850-b21e-3c1c8d7e5c6e"
                },
                "last_name": {
                    "type": "string",
                    "example": "Doe"
        ...
        "usecases.GetBookingOutput": {
            ...
            "properties": {
                ...
                "guests": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/usecases.GetBookingGuestsOutput"
                    }
                },
                "overnight": {
                    "type": "integer",
        ...
        "usecases.RegisterUserOutput": {
            ...
            "properties": {
                "id": {
                    "type": "string",
                    "example": "506e8278-3b39-424e-84e8-c3a1877070b7"
                }
            }
        }
    }
